...
public class AppMain {
	...
	public static void main(String[] args) {
		...
		funcionario1.setCargo("Garcom");
		funcionario1.setGenero("Masculino");
		funcionario1.setEmail("mvvm@discente.ifpe.edu.br");
		funcionario1.setIdade("21");

		Funcionario funcionario2 = new Funcionario();
		funcionario2.setNome("Flavio");
		funcionario2.setCargo("Veterinario");
		funcionario2.setGenero("Masculino");
		funcionario2.setEmail("fwso@discente.ifpe.edu.br");
		funcionario2.setIdade("22");

		Funcionario funcionario3 = new Funcionario();
		funcionario3.setNome("Leo");
		funcionario3.setCargo("Excursionista");
		funcionario3.setGenero("Masculino");
		funcionario3.setEmail("leonardo.lima@palmares.ifpe.edu.br");
		...
		try (Scanner scanner = new Scanner(System.in)) {
			...
			System.out.println("Ola, meu nome e " + funcionario3.getNome() + " sou o " + funcionario3.getCargo() + " do zoológico. A onde deseja ir " + visitante.getNome() + "?");
			System.out.println();
			...
			do {
				...
				case 2:
					if (habitatAtual != 1) {
						...
						System.out.println("Voce precisa estar em um habitat para ir para o outro habitat.");
					}
					break;
				case 3:
				...
				case 5:
					...
					if (escolhaRestaurante == 'S' || escolhaRestaurante == 's') {
						...
						System.out.println("1. Opção 1 (Prato Feito)");
						System.out.println("2. Opção 2 (Lanche)");
